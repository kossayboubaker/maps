...
const App = () => {
  ...
  return (
    <div className={`min-h-screen ${isAsideOpen ? 'bg-background' : 'bg-white'} overflow-hidden`}>
      ...
      <div className="flex w-full" style={{ height: 'calc(100vh - 10px)', maxHeight: 'calc(100vh - 10px)', overflow: 'hidden' }}>
        <aside
        ...
        <button
          ...
          style={{
            ...
            left: '10px',
            zIndex: 3000,
            background: 'linear-gradient(135deg, #159ceaff 0%, #1a71c8ff 100%)',
